...
public struct LifeAdminItem: Codable, Identifiable, Equatable, Sendable {
    public var id: UUID; public var title: String; public var description: String?; public var category: LifeCategory; public var status: ItemStatus; public var priority: Priority; public var priorityOverride: Priority?; public var dueDate: Date?; public var endDate: Date?; public var amount: Decimal?; public var currency: String?; public var recurrence: Recurrence; public var recurrenceRule: String?; public var reminderOffsets: [Int]; public var notes: String?; public var tags: [String]; public var attachments: [Attachment]; public var contact: ContactInfo?; public var location: String?; public var createdAt: Date; public var updatedAt: Date
    public init(id: UUID = UUID(), title: String, description: String? = nil, category: LifeCategory = .other, status: ItemStatus = .active, priority: Priority = .low, priorityOverride: Priority? = nil, dueDate: Date? = nil, endDate: Date? = nil, amount: Decimal? = nil, currency: String? = nil, recurrence: Recurrence = .none, recurrenceRule: String? = nil, reminderOffsets: [Int] = [], notes: String? = nil, tags: [String] = [], attachments: [Attachment] = [], contact: ContactInfo? = nil, location: String? = nil, createdAt: Date = Date(), updatedAt: Date = Date()) { self.id=id; self.title=title; self.description=description; self.category=category; self.status=status; self.priority=priority; self.priorityOverride=priorityOverride; self.dueDate=dueDate; self.endDate=endDate; self.amount=amount; self.currency=currency; self.recurrence=recurrence; self.recurrenceRule=recurrenceRule; self.reminderOffsets=reminderOffsets; self.notes=notes; self.tags=tags; self.attachments=attachments; self.contact=contact; self.location=location; self.createdAt=createdAt; self.updatedAt=updatedAt }
}
